...
class MatColor {
  static const Color primaryDarkColor = const Color(0xFFAAB7B8);
  ...
  static const Color primaryColor = const Color(0xFFAAB7B8);
  static const Color accentColor = const Color(0xFFAAB7B8);
